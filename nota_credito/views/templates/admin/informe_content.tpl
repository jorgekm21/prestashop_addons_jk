            ...
            <center>
                <table class="table table-bordered">
                    <tr>
                        ...
                        <th class="text-center"># de Nota de Credito</th>
                        <th class="text-center">Campana Creada</th>
                        <th class="text-center"># de Referencia</th>
                        <th class="text-center">Monto de la Nota</th>
                    </tr>

                     {foreach from=$tabla item=tablas}
                    <tr>
                        <td class="text-center">{$tablas.cedula_rep}</td>
                        <td class="text-center">{$tablas.num_nota}</td>
                        <td class="text-center">{$tablas.name}</td>
                        <td class="text-center">{$tablas.num_ref}</td>
                        <td class="text-center">{$tablas.sub_total}</td>
                    </tr>
                    {/foreach}
